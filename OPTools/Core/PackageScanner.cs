...
namespace OPTools.Core
{
    ...
    public class PackageScanner
    {
        ...
        private List<(string Path, string Marker)> FindPythonProjects(string rootPath, IProgress<string>? progress)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                try
                {
                    ...
                    // Bolt: Preferred EnumerateDirectories over GetDirectories to reduce memory pressure
        ...
        private string? FindCppMarker(string directory)
        {
            ...
            try
            {
                // Bolt: Use EnumerateFiles and FirstOrDefault to avoid allocating an array
