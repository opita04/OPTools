...
public sealed class PermissionRepairer
{
    ...
    private IEnumerable<string> EnumerateTargetPaths()
    {
        ...
        // Using EnumerateDirectories and EnumerateFiles instead of GetDirectories/GetFiles
        // prevents allocating a massive string array for deep directory structures,
        // reducing memory pressure and time-to-first-result.
