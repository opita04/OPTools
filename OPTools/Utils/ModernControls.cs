...
public class ModernButton : Button
{
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        // Draw Focus Rectangle for Keyboard Accessibility
        if (this.Focused && this.ShowFocusCues)
        {
            Rectangle focusRect = this.ClientRectangle;
            focusRect.Inflate(-4, -4); // slight inset
            ControlPaint.DrawFocusRectangle(graphics, focusRect, this.ForeColor, this.BackColor);
        }
    }
...
public class SidebarButton : Button
{
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        {
            Rectangle focusRect = this.ClientRectangle;
            focusRect.Inflate(-3, -3); // slight inset
            ControlPaint.DrawFocusRectangle(graphics, focusRect, fg, bg);
        }
    }
